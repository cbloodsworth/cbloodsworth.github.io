  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Leading development of a Rust crate that provides a safer interface to the framework's C++/Fortran libraries.}
        \resumeItem{Designed tools to measure code coverage for the framework's domain-specific scripting language.}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Designed and implemented a compiler for an academic language.}
        \resumeItem{Included parsing program text to an AST and Java source code generation.}
      \resumeItemListEnd
